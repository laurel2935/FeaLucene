...
package org.archive.access.analyzer;

import java.io.Reader;
import java.util.Hashtable;

import org.archive.access.utility.parser.LowerCaseTokenizer;
import org.archive.access.utility.parser.StopFilter;
import org.archive.access.utility.parser.TokenStream;
...
public class PorterStemAnalyzer extends Analyzer
{
    ...
    {
    	PorterStemFilter porterStemFilter = new PorterStemFilter(new StopFilter(new LowerCaseTokenizer(reader), _stopTable));
        return null;
    }
