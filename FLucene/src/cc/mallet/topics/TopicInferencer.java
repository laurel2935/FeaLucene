...
public class TopicInferencer implements Serializable {
	...
	private void writeObject (ObjectOutputStream out) throws IOException {
		...
		//System.out.println("version: "+CURRENT_SERIAL_VERSION);
		...
		//System.out.println("topicMask: "+topicMask);
		out.writeInt(topicBits);
		//System.out.println("topicBits: "+topicBits);
		...
		//System.out.println("typeTopicCounts: "+typeTopicCounts);
		
		out.writeObject(tokensPerTopic);
		//System.out.println("tokensPerTopic: "+tokensPerTopic);
		...
		//System.out.println("cachedCoefficients: "+cachedCoefficients);
	}
	...
	public void outputD(double [] dArray){
	...
	public void outputI(int [] iArray){
		for(double i: iArray){
			System.out.print(i+"  ");
		}
		System.out.println();
